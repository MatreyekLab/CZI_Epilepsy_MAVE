...
```{r Load relevant packages, error = F}
...
```{r Importing all of the relevant data, error=FALSE, warning=FALSE, message=FALSE}
...
```{r Importing some curated Epilepsy gene lists from the literature, error=FALSE, warning=FALSE, message=FALSE}
...
Next incorporate the list of constructs we had cloned or already made plans to clone
```{r Incoporating our already cloned constructs, error=FALSE, warning=FALSE, message=FALSE}
...
```{r Coming up with the intended list to potentially study, error=FALSE, warning=FALSE, message=FALSE}
...
```{r ClinVar, error=FALSE, warning=FALSE, message=FALSE}
...
First up is looking at the barcode for the Gibsons using Amp-EZ miSeq 500 cycle sequencing
```{r Look at L062 barcoding again, error=FALSE, warning=FALSE, message=FALSE}
...
```{r Look at L062 Gibson AmpEZ  barcoding again to see if there is a barcoding bias, error=FALSE, warning=FALSE, message=FALSE}
...
```{r Look at L062 barcoding data, error=FALSE, warning=FALSE, message=FALSE}
